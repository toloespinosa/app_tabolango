...
<div id="app-detalle" class="tabolango-view">
    ...
    <div class="stats-filter-bar">
        <div class="filtred-wrapper">
            <button class="filter-btn active" id="btn-filtro-mes" onclick="toggleDrop('drop-meses', event)">MES</button>
            <div id="drop-meses" class="mini-drop"></div>
        </div>
        <div class="filtred-wrapper">
    ...
    <div class="btn-reset-round" onclick="manejarClickSimple()"><i class="fas fa-undo-alt"></i></div>
        ...
        <div id="ui-recurring-container" class="recurring-box" style="display:none;"></div>
